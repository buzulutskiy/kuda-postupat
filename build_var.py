...
CHOICE = [
 {"k":"физика","t":"Как работают машины и электричество","label":"Математика + физика",
  ...
  "risks":[
    ["Каждый пятый не доживает до второго курса","Исследование по 34 вузам на инженерных "
     "направлениях: с первого курса выбывают 19,3%, а с третьего — уже 4,8%. Весь отсев "
     "приходится на первый год, и половина его — академическая неуспеваемость."],
    ["Сумма 145 — это профиль отчисленного","В разборе одного транспортного вуза средний "
     "суммарный балл ЕГЭ у отчисленных на первом курсе оказался ровно 145, а у отчисленных "
     "на старших курсах — 165–170. То есть слабый входной балл вылезает именно в первую сессию."],
 ...
 {"k":"биология","t":"Как устроено живое","label":"Математика + биология",
  ...
  "risks":[
    ...
    ["Проще учиться — не факт","Кажется, что на аграрном и пищевом отсев меньше, чем "
     "на техническом. Данные этого не подтверждают: в экспертных оценках сельское хозяйство "
     "стоит в группе с высоким отсевом, рядом с инженерией. Официальной статистики по "
     "направлениям не существует вообще."],
...
.fct{{display:flex;gap:18px;align-items:baseline;margin-top:15px;padding-top:14px;
  border-top:1px solid var(--line2)}}
.fct b{{font-family:Vollkorn,serif;font-size:30px;color:var(--bad);flex:none;line-height:1;
  font-variant-numeric:tabular-nums;min-width:80px}}
.fct span{{font-size:14.5px}}
.fct span i{{font-style:normal;display:block;font-size:12.5px;color:var(--faint);margin-top:5px}}
.fct span i a{{color:var(--faint)}}
/* тест */
...
<div class="big" style="border-color:var(--bad)">
  <h2>Поступить — половина дела. Дальше первый курс</h2>
  <p>Это та часть, о которой при выборе предметов обычно не думают, а она решает не меньше.</p>

  <div class="fct"><b>19,3%</b><span>студентов инженерно-технических направлений выбывают
    <b>с первого курса</b>. С третьего — уже 4,8%. Весь отсев приходится на первый год.
    <i>Исследование по 34 вузам, «Вопросы образования», 2020 ·
    <a href="https://cyberleninka.ru/article/n/faktory-otseva-studentov-inzhenerno-tehnicheskogo-profilya-v-rossiyskih-vuzah">текст</a></i></span></div>

  <div class="fct"><b>145</b><span>средний суммарный балл ЕГЭ у тех, кого отчислили
    <b>на первом курсе</b>. У отчисленных на старших курсах — 165–170. Слабый входной балл
    вылезает именно в первую сессию.
    <i>Разбор отчислений в транспортном вузе, 2018 ·
    <a href="https://cyberleninka.ru/article/n/o-zakonomernostyah-i-prichinah-otchisleniy-v-vuze-i-motivatsii-uchebnoy-deyatelnosti-studentov">текст</a></i></span></div>

  <div class="fct"><b>×1,6</b><span>во столько раз выше риск вылететь у тех, кто сдал математику
    на 50 баллов и ниже. Цифра неприятная, но <b>не главная</b> — смотри следующую.
    <i>Там же, Шмелева и Фрумин, 2020</i></span></div>

  <div class="fct"><b>×4,6</b><span>во столько раз выше риск у тех, кто ходит меньше чем
    на 80% занятий. <b>Посещаемость влияет почти втрое сильнее входного балла.</b>
    Это и есть хорошая новость: слабый старт компенсируется тем, что ты просто ходишь
    на пары и не копишь хвосты.
    <i>Там же</i></span></div>

  <h3 style="margin-top:20px">Честно про то, чего в данных нет</h3>
  <p>Хотелось бы сказать, что на аграрных и пищевых направлениях учиться безопаснее.
  <b>Данные этого не подтверждают.</b> Официальной статистики отсева по направлениям
  в России вообще не существует, а единственная экспертная оценка ставит сельское хозяйство
  в одну группу с инженерией — с высоким отсевом. Поэтому выбирать аграрное «потому что там
  проще доучиться» — необоснованно. Выбирать его стоит только потому, что интересно.</p>

  <h3>Правило, которое стоит запомнить заранее</h3>
  <p>Если в вузе станет ясно, что не тянешь — <b>уходить надо по собственному желанию,
  не дожидаясь отчисления за неуспеваемость.</b> Разница огромная:</p>
  <ul class="steps" style="margin-top:12px">
    <li><b>Ушёл сам.</b> Пять лет право восстановиться, причём на прежних условиях —
    то есть снова на бюджет. Отсрочка от армии сохраняется.</li>
    <li><b>Отчислили за неуспеваемость.</b> Федеральных гарантий восстановления нет —
    только на условиях самого вуза. <b>Отсрочка от армии теряется</b>, и второй раз
    её уже не дадут. С 2026 года призыв круглогодичный, пересидеть между призывами нельзя.</li>
  </ul>
  <p>И промежуточный вариант: академический отпуск до года — отсрочка сохраняется,
  можно взять паузу и вернуться.</p>
</div>
